...
export default function Home() {
  ...
  return(
    <>
      ...
      <div className="container mx-auto h-[20vh] p-6 bg-white border border-gray-200 flex justify-between m-8 ">
      ...
      <div className="flex justify-between w-full space-x-2 mb- 4">
...
" />
    ...
    <div className="h-screen bg-white flex flex-col justify-center items-start p-10">
      ...
      <div className="flex">
        <div className="border-l-4 border-[##40C2FC] h-full mr-6 pl-6">
